...
class GmailClient(Protocol):
    ...
    def modify_message(self, message_id: str, add_label_ids: list[str] | None = None, remove_label_ids: list[str] | None = None) -> dict[str, Any]: ...


class GoogleGmailClient:
    def __init__(self, service_account_file: Path | None, subject: str, service_account_info: dict[str, Any] | None = None):
        if not subject:
            raise ValueError("A delegated Workspace subject is required.")
        ...
        if service_account_info is not None:
            ...
            raise ValueError("A service-account file or SOPS service_account_json is required.")
...
class UserOAuthGmailClient(GoogleGmailClient):
    def __init__(self, credentials_file: Path | None = None, credentials_info: dict[str, Any] | None = None):
        ...
        if credentials_info is not None:
            ...
            raise ValueError("A user OAuth credentials file or SOPS user_credentials_json is required.")
        self.service = build("gmail", "v1", credentials=credentials, cache_discovery=False)
        self.user_id = "me"
